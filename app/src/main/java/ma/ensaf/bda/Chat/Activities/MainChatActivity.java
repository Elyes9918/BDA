...
import ma.ensaf.bda.Chat.UtilitiesChat.UserAdapterChat;
...
public class MainChatActivity extends BaseActivity implements UserListeners {
    ...
    private void UpdateToken(String token){
        ...
        hashMap.put(KEY_FCM_TOKEN, token);
    ...
    private void readUsers(){
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child(KEY_TABLE_CHAT);
