...
import ma.ensaf.bda.databinding.ItemContainerReceivedMessageBinding;
import ma.ensaf.bda.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(Message chatMessage,String reciverProfileImage){
            binding.textMessage.setText(chatMessage.getMessage());
            binding.textDateTime.setText(chatMessage.getTimestamp());

            if(reciverProfileImage != null){
                Glide.with(context).load(reciverProfileImage).into(binding.navUserImage);
            }
