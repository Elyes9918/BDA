...
import ma.ensaf.bda.databinding.ActivityDonarRegistrationBinding;
...
public class DonarRegistrationActivity extends AppCompatActivity {
    ...
    private ActivityDonarRegistrationBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDonarRegistrationBinding.inflate(getLayoutInflater());
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(!task.isSuccessful()){
                    ...
                    userInfo.put(KEY_TYPE,"donor");
                    userInfo.put(KEY_SEARCH,"donor"+bloodGroup);
                                ...
                                if(taskSnapshot.getMetadata() != null && taskSnapshot.getMetadata().getReference() != null){
                                    ...
                                    Result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            HashMap<String,Object> newImageMap = new HashMap<>();
